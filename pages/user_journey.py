    ...
    try:
        ...
        if user_id:
            ...
            with st.expander("차트 해석 방법"):
                st.markdown("""
                ### 차트 설명
                이 차트는 사용자의 6개 카테고리별 진보/중도/보수 점수를 시간에 따라 보여줍니다.
                
                ### 표현 방식
                - **색상**: 진보(파랑), 중도(보라), 보수(빨강)을 의미합니다.
                - **선 스타일**: 카테고리를 구분하기 위해 서로 다른 선 스타일을 사용합니다.
                
                ### 점수 해석
                - 점수 범위는 0~100이며 값이 높을수록 해당 성향에 가깝습니다.
                - 기준선 50은 초기 중립값으로 참고할 수 있습니다.
